...
export class AddAssignmentComponent implements OnInit {
  ...
  onSubmit() {
    ...
    console.log("idMatiere"+this.formGroup.value.formArray[2].idMatiere);
    let i=this.matieres.findIndex(m=>m._id===this.formGroup.value.formArray[2].idMatiere);
    console.log("index"+i);
    nouvelAssignment.matiere =this.matieres[i];
    nouvelAssignment.auteur=this.formGroup.value.formArray[3].auteur;
